...
TEST_CASE("Print RadiusPacket") {
    ...
    stream << packet;
    REQUIRE(stream.str() == "1 Code = 1(Access-Request)"+NL+
                            "1 ID = 1"+NL+
                            "2 Length = 20"+NL+
                            "16 Authenticator"+NL+
                            "Attributes:"+NL+
...
TEST_CASE("Print RadiusPacket with AVPs") {
    ...
    std::ostringstream stream;
    stream << packet;
    REQUIRE(stream.str() == "1 Code = 2(Access-Accept)"+NL+
                            "1 ID = 1"+NL+
                            "2 Length = 42"+NL+
                            "16 Authenticator"+NL+
                            "Attributes:"+NL+
...
TEST_CASE("Print EapPacket") {
    ...
    REQUIRE(stream.str() == "1 Type = 3(Success)"+NL+
                            "1 ID = 1"+NL+
                            "2 Length = 4"+NL+
                            "Type-data:"+NL+
                            "    None"+NL);
    ...
    stream << packet;
    REQUIRE(stream.str() == "1 Type = 1(Request)"+NL+
                            "1 ID = 1"+NL+
                            "2 Length = 8"+NL+
                            "Type-data:"+NL+
                            "    4 Identity: foo"+NL);
